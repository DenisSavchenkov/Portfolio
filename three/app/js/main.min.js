...
$((function(){$(".slider").slick({infinite:!0,slidesToShow:3,slidesToScroll:3,autoplay:3e3,prevArrow:'<button type="button" class="slick-prev"></button>',nextArrow:'<button type="button" class="slick-next"></button>',responsive:[{breakpoint:1120,settings:{slidesToShow:2,slidesToScroll:2,dots:!1}},{breakpoint:845,settings:{slidesToShow:1,slidesToScroll:1,dots:!1}}]}),$(".testimonials-slider").slick({infinite:!0,slidesToShow:2,slidesToScroll:2,prevArrow:'<button type="button" class="slick-prev"></button>',nextArrow:'<button type="button" class="slick-next"></button>',responsive:[{breakpoint:1430,settings:{slidesToShow:1,slidesToScroll:1,dots:!1}}]}),(new WOW).init(),$(".menu-burger").on("click",(function(){$(".menu-list").slideToggle()}))}));